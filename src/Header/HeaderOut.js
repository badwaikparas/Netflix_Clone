    ...
    return (
        <div class="default-ltr-cache-1lr0euo e1iw2qjb0">
            <header data-uia="nmhp-card-header" class=" default-ltr-cache-i6d2tb e1bzn5xj1">
                <div data-layout="wrapper" class=" default-ltr-cache-1fhvoso eslj5pt1">
                    <div data-layout="container" class="default-ltr-cache-1ih16e8 eslj5pt0">
                        <div data-layout="item" class=" default-ltr-cache-35cwt6 ew2l6qe0"><span
                            ...
                            </svg><span class="default-ltr-cache-raue2m ev1dnif1">Netflix</span></span></div>
                        <div data-layout="item" class=" default-ltr-cache-7ejomh ew2l6qe0">
                            <div data-layout="wrapper" class=" default-ltr-cache-1fhvoso eslj5pt1">
                                <div data-layout="container" class="default-ltr-cache-p63fvi eslj5pt0">
                                    <div data-layout="item" class=" default-ltr-cache-7ujrbr ew2l6qe0"><span
                                        class="default-ltr-cache-1sk81mw e1bzn5xj0">
                                        <div data-uia="language-picker-header+container"
                                            class=" e1jlx6kl1 default-ltr-cache-1d7jpaj ea3diy35"><label for=":R5ajalalbd:"
                                                data-uia="language-picker-header+label"
                                                class="default-ltr-cache-1vw5kt6 ea3diy32">Select Language</label>
                                            <div class="default-ltr-cache-fmygl2 ea3diy34">
                                                <div role="img" aria-hidden="true"
                                                    class="default-ltr-cache-iyxs8w e1vkmu654"><svg width="16" height="16"
                                                    ...
                                                    </svg></div><select id=":R5ajalalbd:" name="LanguageSelect"
                                                        data-uia="language-picker-header">
                                                    <option lang="en" label="English" value="en-IN" selected="">English
                                                    </option>
                                                    <option lang="hi" label="हिन्दी" value="hi-IN">हिन्दी</option>
                                                </select>
                                                <div aria-hidden="true" class="default-ltr-cache-emv211 ea3diy33"><svg
                                    ...
                                    <div data-layout="item" class=" default-ltr-cache-11adcsa ew2l6qe0">
                                        <div><a role="button" class=" e1ax5wel1 ew97par0 default-ltr-cache-1clcoym e1ff4m3w1"
                                            id="signIn" data-uia="header-login-link" href="/in/login">Sign In</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
